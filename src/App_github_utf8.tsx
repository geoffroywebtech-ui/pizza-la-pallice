...
const MENU_ITEMS: MenuItem[] = [
  ...
  { 
    id: '13', 
    name: 'Romaine', 
    ingredients: "oignons, filets d'anchois, c├ópres, poivrons, fromages, olives, origan", 
    prices: { t1: 9.50, t2: 11.50, t3: 13.50 }, 
    category: 'classique',
    image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=800'
  },
          ...
          <div className="relative rounded-[3rem] overflow-hidden aspect-square lg:aspect-auto lg:h-[600px]">
            ...
            <div className="absolute bottom-8 left-8 right-8 bg-brand-yellow p-8 rounded-[2rem] shadow-2xl">
              ...
              <p className="text-brand-green italic font-serif font-bold">
                "La meilleure pizza de La Rochelle, sans aucun doute. La p├óte est incroyable et l'accueil toujours chaleureux."
              </p>
            </div>
          </div>
